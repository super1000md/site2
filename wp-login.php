		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="登录" />
									<input type="hidden" name="redirect_to" value="https://www.taijifuzhou.com/wp/wp-admin/" />
...
<script>
var _zxcvbnSettings = {"src":"https:\/\/www.taijifuzhou.com\/wp\/wp-includes\/js\/zxcvbn.min.js"};
</script>
