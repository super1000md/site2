					...
					<div class="recom-plugin-wrap">
						<div class="plugin-img-wrap">
							...
							<div class="version-author-info">
								<span class="version"><?php echo esc_html__('Version ', 'opstore') . esc_html($plugin['version']); ?></span>
			...
			?>
				<div class="recom-plugin-wrap">
					<div class="plugin-img-wrap">
						<img src="<?php echo esc_url($icon_url); ?>" />
						<div class="version-author-info">
							<span class="version"><?php echo esc_html__('Version ', 'opstore') . esc_html($info->version); ?></span>
							<span class="seperator">|</span>
