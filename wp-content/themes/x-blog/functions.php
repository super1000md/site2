...
add_action( 'enqueue_block_editor_assets', 'x_blog_gb_block_style' );
...
function x_blog_scripts() {
	...
	wp_enqueue_style( 'xblog-responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(),1.0,'all' );

	
	wp_enqueue_script( 'xblog-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'xblog-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '20151215', true );
