			...
			'getting_started' => array(
                ...
                'seven' => array(
					...
					'recommended_actions'        => array(
						...
						'content'            => array(
							'click-to-top' => array(
								'title'       => __('Gallery Box', 'x-blog-plus' ),
...
function xblog_plus_new_optins_texts() {
    ...
    if(get_option('xpntext54')){
        return;
    }
	$class = 'eye-notice notice notice-warning is-dismissible';
	$message = __( '<span style="color:red"><strong> Hi Buddy!! Now You are usign the Free version. If you happy with the free version then good. But</span><br><span style="color:blue"> If you want a beautiful, orderly, SEO friendly, more secure and unlimited options website then need to upgrade pro. UPGRADE FOR LIFETIME WITH NOMINAL PRICE.</span> <span style="color:red;"><br>Good News: XBLOG RPO theme Now support Woocommerce plugin so now you can sell anything with XBLOG Pro theme.<br> </span><span style="color:green;"> XBLOG PRO theme also support both ltr and RTL Languages !!!</strong></span> ', 'x-blog-plus' );
