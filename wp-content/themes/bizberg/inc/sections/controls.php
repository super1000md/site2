...
class Bizberg_Customize_Section extends WP_Customize_Section {
	...
	public function get_recommended_plugins(){
		...
		<li id="accordion-section-recommended-plugins-customizer" class="accordion-section control-section control-section-recommended-plugins-customizer cannot-expand recommended-plugins-customizer">
			...
			<div class="tb_recommended_plugins_wrapper">
				<ul>
					...
					if( !defined( 'ELEGANTBLOCKS_PLUGIN_URL' ) ){ ?>
						<li id="elegant-blocks">
							<a href="https://wordpress.org/plugins/elegant-blocks/" target="blank">
								<?php esc_html_e( 'Elegant Blocks – Amazing Gutenberg Blocks', 'bizberg' ); ?>		
							</a>
						</li>
						<?php 
					} 
					...
					if( !class_exists( 'UAGB_Config' ) ){ ?>
						...
						<li id="ultimate-addons-for-gutenberg">
							<a href="https://wordpress.org/plugins/ultimate-addons-for-gutenberg/" target="blank">
								<?php esc_html_e( 'Ultimate Addons for Gutenberg', 'bizberg' ); ?>		
							</a>
						</li>
						<?php 
					} 
				...
				<p>
					<strong>
						<?php esc_html_e( 'Note : After installing and activating plugins, it will take you to the demo import page.', 'bizberg' ); ?>		
					</strong>
				</p>
