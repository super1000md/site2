...
if (!class_exists('Web_Log_Recent_Post_Widget')) :
   
    class Web_Log_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title'      => esc_html__('Recent Posts','web-log'),
                'no_of_post' => 3,
                'show_date'  => 1,
        ...
        function __construct()
        {
            $opts = array(
                ...
                'classname'   => 'web-log-recent-widget',
                'description' => esc_html__('TM: Recent Post Widget', 'web-log'),
            );

            parent::__construct('web-log-recent-post', esc_html__('TM: Recent Post Widget', 'web-log'), $opts);
        }
				...
				<li>
					...
					<div class="side-item">
						...
						<div class="side-image">
							<a href="<?php echo esc_url(get_permalink()) ?>" rel="bookmark"><?php the_post_thumbnail('web-log-thumbnail-5', array('class' => 'side-item-thumb')); ?></a>
						</div>
						<?php endif; ?>
     ...
     public function update( $new_instance, $old_instance ){
        ...
        public function form($instance ){
          ...
          ?>
          <p>
                <label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><strong><?php _e( 'Title', 'web-log' ); ?></strong></label><br />
             ...
             <p>
                 <label for="<?php echo $this->get_field_id('no_of_post'); ?>"><strong><?php _e( 'Number of posts to show:', 'web-log' ); ?></strong></label><br />
              ...
              <p>
                ...
                <label for="<?php echo  esc_attr( $this->get_field_id( 'active_slider' ) ); ?>"><strong><?php echo esc_html__( 'Show Post Date' ,'web-log'); ?></strong></label>
...
add_action( 'widgets_init', 'web_log_recenet_post_widget' ); 
function web_log_recenet_post_widget(){     
    register_widget( 'Web_Log_Recent_Post_Widget' );
}