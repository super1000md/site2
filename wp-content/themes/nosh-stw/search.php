...
<nav aria-label="breadcrumb">
  ...
  <?php     
        esc_html_e('Search results for: ','nosh-stw'); ?><b><i><?php the_search_query(); ?></i></b>
...
<?php if ( !have_posts() ) : ?>
		<div class="post-outer-container col">
      <div class="text-center">
      <p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'nosh-stw' ); ?></p>
			<?php
				get_search_form(); ?>
    </div>
    </div>
...
<article class="post-outer-container col-lg-12">
...
<div id="post-snippet-<?php the_ID(); ?>" <?php post_class( 'post-body entry-content' ); ?>>
