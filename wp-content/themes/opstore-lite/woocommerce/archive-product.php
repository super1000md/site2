    	...
    	<div class="<?php echo esc_attr( $container_class ); ?> view-grid">
			<?php if ( have_posts() ) : ?>
				<?php if( ! is_search() ): ?>
					...
					<?php 
					$before_shop = get_theme_mod('opstore_before_shop');
					if($before_shop && defined('ELEMENTOR_VERSION')){
						echo '<div class="before-shop-wrap">';
						echo \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $before_shop );
						echo '</div>';
					}
					?>
